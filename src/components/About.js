...
const About = () =>{
    return(
        <div id="SobreMi">
            <div className="container mx-auto pl-4 pr-4 xl:pl-60 xl:pr-60 xl:pt-16">
                ...
                <div className="text-white md:columns-2 ">
                    ...
                    <div className='md:flex items-center'>
                        ...
                        <div className='text-center'>
                            ...
                            <a className="text-2xl md:text-3xl mt-4 pt-2 pb-2 bg-color-green rounded-2xl pl-4 pr-4 box-shadow-custom mt-8" href={CV} target="_blank" rel="noopener noreferrer" download="CV-Antonio-GH-2022.pdf">Descargar CV <i className="fa fa-file-pdf"></i></a>
                        </div>
                    </div>
